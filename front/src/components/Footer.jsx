...
export default function Footer() {
  ...
  const selectList = [
    ...
    {
      value:
        "https://www.happypointcard.com/page/main/index.spc;jsessionid=CCBA4D2721ACDE8DA5605FFE0E96E5AC",
      name: "해피포인트카드",
    },
      ...
      <div>
        <nav>
          <ul className="footer_top_navs">
            <li>
              <Link to="/store/newstore">
                <p className="footer_top_nav">신규직영점 입점제의</p>
              </Link>
            </li>
            <li>
              <Link to="/store/openstore">
                <p className="footer_top_nav">점포개설문의</p>
              </Link>
            </li>
            <li>
              <a href="https://spc.recruiter.co.kr/appsite/company/index">
                <p className="footer_top_nav">채용문의</p>
              </a>
            </li>
            <li>
              <a href="https://www.spc.co.kr/share/right-mng/spc-operation/">
                <p className="footer_top_nav">윤리신고센터</p>
              </a>
            </li>
            <li>
              <a href="https://www.happypointcard.com/page/customer/term.spc">
                <p className="footer_top_nav">해피포인트카드 이용약관</p>
              </a>
            </li>
            <li>
              <Link to="/cscenter/policy-reward">
                <p className="footer_top_nav">베스킨라빈스 리워드 이용약관</p>
              </Link>
            </li>
            <li>
              <Link to="/cscenter/policy">
                <p className="footer_top_nav">개인정보처리방침</p>
              </Link>
            </li>
            <li>
              <Link to="/cscenter/policy-cctv">
                <p className="footer_top_nav">영상정보처리기기운영관리방침</p>
              </Link>
            </li>
            <li>
              <Link to="/cscenter/safety-management">
                <p className="footer_top_nav">안전보건 경영방침</p>
              </Link>
            </li>
          </ul>
        </nav>
      ...
      <div className="footer_bottom">
        <div>
          <a href="https://www.happypointcard.com/page/main/index.spc">
            <img
              className="footer_bottom_img"
              src="/images/btn_happy_point.png"
            />
          </a>
        ...
        <div className="footer_bottom_right">
          ...
          <select className="footer_selectbox" onChange={handleSelect}>
            {selectList.map((item) => (
